...
const PATIENTS = [
  ...
  { name: '환자삼', gender: '남성', birthday: '' },
  { name: '환자사', gender: '남성', birthday: '' },
  { name: '환자오', gender: '남성', birthday: '' },
  { name: '환자육', gender: '여성', birthday: '' },
  { name: '환자칠', gender: '여성', birthday: '' },
  { name: '환자팔', gender: '여성', birthday: '' },
  { name: '환자구', gender: '여성', birthday: '' },
  { name: '환자십', gender: '여성', birthday: '' },
